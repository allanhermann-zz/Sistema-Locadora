...
$catg = $_POST['categorias'];
$movie = "nome";

$sqldvd = pg_query($connect, "SELECT nome FROM dvd WHERE categoria like '%$catg%'");
$sqlbluray = pg_query($connect, "SELECT nome FROM bluray WHERE categoria like '%$catg%'");
