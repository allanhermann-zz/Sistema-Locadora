...
$sqldvd = pg_query($connect, "SELECT nome FROM dvd WHERE atores like '%$ator%'");
$sqlbluray = pg_query($connect, "SELECT nome FROM bluray WHERE atores like '%$ator%'");
...
pg_close($connect);
?>
<h2>Caso deseje mais informações sobre um filme, copie o nome, volte e pesquise pelo nome completo.</h2></div>
</body>
</html>